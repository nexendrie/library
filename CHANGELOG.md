Version 0.7.0-dev
- test also on PHP 7.3 and 7.4
- use phing's targets from nexendrie/code-quality
- raised minimal version of PHP to 7.3
- test also with lowest possible version of dependencies

Version 0.6.0
- added more files to .gitignore and .gitattributes
- travis is no longer allowed to fail with PHP 7.2
- fixed path for dev-autoloading
